...
def eia_data_load_main(): 
    ...
    #API key
    eia_api = 'oPQlLy1q5IDBMux5o21AVy9vqXamjuEePE2gVAZE'
...
df_demand = eia_data_load_main()

# add dummy rows corresponding to missing periods
df_demand = fill_gaps_dt(df_demand)

# summary information of missing values
summarize_missing(df_demand)
...
df_demand.to_csv('data/demand_2024_05_16.csv')
